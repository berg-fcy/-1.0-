<template>
  <div>
    ...
    <el-form :rules="rules"
      ...
      <el-link :underline="false" class="loginAdmin" @click="adminLogin">管理员登录</el-link>
      <el-link :underline="false" type="primary" class="loginRegister" @click="Register">还未注册？注册</el-link>
